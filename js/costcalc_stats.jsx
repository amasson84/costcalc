                ...
                <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <p> In order to improve this tool we have implemented a statistical engine that give us
                                information about how you use this cost calculator tool.</p>
                            <p>Only <span className="font-weight-bold">Anonymous</span> information are recorded.</p>
                        ...
                        <div className="modal-footer bg-light">
                            <p className="font-weight-bold">Accepting or Refusing this recording will have not impact on
                                the usage of the tools</p>
                            <button type="button" className="btn btn-danger" data-dismiss="modal" onClick={Stats.ConsentOff.bind(Stats)}>I Refuse</button>
                            <button type="button" className="btn btn-success" data-dismiss="modal" onClick={Stats.ConsentOn.bind(Stats)}>I Accept</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="card">
                    ...
                    <div id="collapseOne" className="collapse" aria-labelledby="headingOne"
                        ...
                        <div className="card-body">
                            ...
                            What we are <span className="font-weight-bold"> never</span> recording :
                            <ul>
